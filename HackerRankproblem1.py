...
2/5 = 0.40000 and 1/5 = 0.200000. Results are printed as:
...
def plusMinus(arr):
    ...
    for i in arr:
        ...
        if i > 0:
            ...
            zeros += 1
    result_positive = positive/numbers
    result_negative = negative/numbers
    result_zeros = zeros/numbers

    print("%.6f" %result_positive)
    print("%.6f" %result_negative)
    print("%.6f" %result_zeros)
